		...
		<div className="bg-gray-100 dark:bg-gray-950 font-sans container mx-auto my-8 px-4 sm:px-6 lg:px-8">
			...
			<div className="bg-white shadow-md rounded-lg p-8">
				...
				<p className="text-gray-700 mb-8">
					...
					development of large-scale software solutions and deploying intuitive
					solutions to meet client design requirements. Michael has a proven
					track record of driving customer satisfaction and is skilled in
					providing technical leadership, resulting in code quality, system
				...
				<div className="mb-8">
					...
					<ul className="list-disc pl-6 text-gray-700">
						<li>
							Architect and build an enterprise-level healthcare portal app with
							Vue, Vuex, Vuetify, Vue Test Utils, and plain JavaScript.
						</li>
						<li>
				...
				<div className="mb-8">
					...
					<ul className="list-disc pl-6 text-gray-700">
						<li>
							Sub-contracted to American Express to work on fintech credit score
							software on an Agile team.
						</li>
						<li>
				...
				<div className="mb-8">
					...
					<ul className="list-disc pl-6 text-gray-700">
						<li>
							Taught students Javascript, React, Node.js, HTML, CSS, Bootstrap,
							Typescript, .NET, and C#.
						</li>
						<li>
							Prepared students for technical interviews and provided a thorough
